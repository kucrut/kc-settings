 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-flexbox_legacy-hsla-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-applicationcache-canvas-canvastext-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websockets-websqldatabase-webworkers-geolocation-inlinesvg-smil-svg-svgclippaths-touch-webgl-shiv-mq-cssclasses-prefixed-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-battery_api-battery_level-canvas_todataurl_type-contenteditable-cookies-css_backgroundposition-shorthand-css_backgroundposition-xy-css_backgroundrepeat-css_boxsizing-css_calc-css_lastchild-css_mediaqueries-css_overflow_scrolling-css_remunit-css_regions-css_resize-css_scrollbars-elem_details-elem_progress_meter-file_api-forms_fileinput-file_filesystem-forms_placeholder-forms_speechinput-forms_validation-fullscreen_api-getusermedia-json-vibration-load
 */
;
...
Modernizr.addTest('getusermedia', !!Modernizr.prefixed('getUserMedia', navigator));// Vibration API
// http://www.w3.org/TR/vibration/
// https://developer.mozilla.org/en/DOM/window.navigator.mozVibrate
Modernizr.addTest('vibrate', !!Modernizr.prefixed('vibrate', navigator));// native JSON support.
